...
const defaultData: ForozStaticData = {
  ...
  blogPage: {
    id: 0,
    logo: null,
    siteName: 'FOROZ Nonprofit',
    heroTitle: 'Empowering Youth Through Education, Skills & Opportunities',
    heroSubtitle:
      'FOROZ is a nonprofit organization dedicated to providing equitable access to education, capacity building, and opportunities for youth and students worldwide.',
    heroCtaText: 'Explore Programs',
    heroCtaLink: '#services',
    heroImage: null,
    aboutSectionSummarize:
      'Founded on September 6, 2025, FOROZ is a dynamic nonprofit organization focused on empowering youth through education, skills development, mentorship, and opportunity facilitation.',
    aboutSection:
      'We believe that every young person deserves the chance to reach their full potential. Our programs span critical areas including English proficiency, mathematics, digital skills, and professional development.\n\nWith a strong emphasis on inclusivity and global accessibility, we are building bridges that connect ambitious students with the resources they need to succeed in an ever-evolving world.',
    aboutImage: null,
    ...
    ctaSubtitle:
      "Join the FOROZ community today. Whether you're a student seeking opportunities, a professional wanting to mentor, or a partner looking to collaborate, your impact starts here.",
    ctaButtonText: 'Join FOROZ Today',
    ctaButtonLink: '/volunteer_form/',
    contactEmail: 'forozorg@gmail.com',
    contactPhone: '',
    contactAddress: '',
    mapEmbedUrl: '',
    footerDescription:
      'Empowering youth globally through education, skills development, and equitable opportunities.',
    copyrightText: '2025 FOROZ Nonprofit Organization. All rights reserved.',
    socialLinks: {
      linkedin: 'https://www.linkedin.com/company/foroz',
      twitter: 'https://x.com/forozorg',
      instagram: 'https://www.instagram.com/forozorg',
...
const dataEndpoints = {
  content: [],
  coreValues: [],
  services: ['/v1/courses/', '/d1/get_services/', '/services/', '/programs/'],
  events: ['/d1/get_events/', '/events/'],
  collaborations: ['/d1/get_collaborations/', '/collaborations/', '/collaboration/'],
  boardMembers: ['/d1/get_members/', '/experts/', '/board-members/', '/team/'],
  impact: [],
  announcements: ['/d1/get_announcements/', '/announcements/'],
};
...
const cloneDefaults = (): ForozStaticData => ({
  ...
  blogPage: {
    ...defaultData.blogPage,
    socialLinks: { ...defaultData.blogPage.socialLinks },
  },
});
  ...
  items.map((item, index) => {
    ...
    return {
      ...
      description:
        ...
        fallback.description,
      icon:
        pickString(source, ['icon', 'icon_name', 'icon_text', 'iconText']) ||
        fallback.icon,
      color:
        pickString(source, ['color', 'accent', 'accentColor', 'accent_color']) ||
        fallback.color,
      gradient:
        pickString(source, ['gradient']) || fallback.gradient,
    };
  });
    ...
    try {
      ...
      if (blogPagePayload) {
        next.blogPage = {
          ...next.blogPage,
          ...blogPagePayload,
          logo: blogPagePayload.logo || next.blogPage.logo,
          siteName: blogPagePayload.siteName || next.blogPage.siteName,
          heroTitle: blogPagePayload.heroTitle || next.blogPage.heroTitle,
          heroSubtitle: blogPagePayload.heroSubtitle || next.blogPage.heroSubtitle,
          heroCtaText: blogPagePayload.heroCtaText || next.blogPage.heroCtaText,
          heroCtaLink: blogPagePayload.heroCtaLink || next.blogPage.heroCtaLink,
          heroImage: blogPagePayload.heroImage || next.blogPage.heroImage,
          aboutSectionSummarize: blogPagePayload.aboutSectionSummarize || next.blogPage.aboutSectionSummarize,
          aboutSection: blogPagePayload.aboutSection || next.blogPage.aboutSection,
          aboutImage: blogPagePayload.aboutImage || next.blogPage.aboutImage,
          missionText: blogPagePayload.missionText || next.blogPage.missionText,
          visionText: blogPagePayload.visionText || next.blogPage.visionText,
          ctaTitle: blogPagePayload.ctaTitle || next.blogPage.ctaTitle,
          ctaSubtitle: blogPagePayload.ctaSubtitle || next.blogPage.ctaSubtitle,
          ctaButtonText: blogPagePayload.ctaButtonText || next.blogPage.ctaButtonText,
          ctaButtonLink: blogPagePayload.ctaButtonLink || next.blogPage.ctaButtonLink,
          contactEmail: blogPagePayload.contactEmail || next.blogPage.contactEmail,
          contactPhone: blogPagePayload.contactPhone || next.blogPage.contactPhone,
          contactAddress: blogPagePayload.contactAddress || next.blogPage.contactAddress,
          mapEmbedUrl: blogPagePayload.mapEmbedUrl || next.blogPage.mapEmbedUrl,
          footerDescription: blogPagePayload.footerDescription || next.blogPage.footerDescription,
          copyrightText: blogPagePayload.copyrightText || next.blogPage.copyrightText,
          socialLinks: Object.keys(blogPagePayload.socialLinks || {}).length > 0
            ? blogPagePayload.socialLinks
            : next.blogPage.socialLinks,
        };
      }
