      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            <div className="absolute inset-0 bg-white rounded-3xl shadow-2xl overflow-hidden flex items-center justify-center p-8 border border-slate-100">
